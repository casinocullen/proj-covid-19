...
x.layer.table = st_read(coririsi_layer, "county_preparedness_score")

names(x.layer.table)

x.layer.table.slim = x.layer.table %>%
  ...
  dplyr::select(geoid,
                ...
                se_score = se_score_1,
                svi_socioeconomic, 
                proj_score = proj_score_1,
                icuover_max_needed,
                icuover_max_needed_100k)

write_layer(x.layer.table.slim, layer.name = "county_preparedness_score_v0_1", layer.type="pg", db=T, fs=T, new.server = T, new.server.overwrite = T)
